...
function PaymentSection() {
    ...
    return (
        <PaymentStyled>
            <InnerLayout>
                <h3 className="small-heading" >An exceptional sevice, <span>at the right price</span></h3>
                ...
                <div className="card-con">
                    ...
                    account={'Premium'}
                    amount={'8$'}
                    text={'Priority support and multi-user access to maximize your productivity.'}
                    button={'Get Started'}
                    card={card}
                    active={active}
                    inactive={inactive}
